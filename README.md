...
Check out [example.js](./example.js) to see an example of this in use with a nes server. Note how the server is setup to handle messages by assigning responses the id in the request.
